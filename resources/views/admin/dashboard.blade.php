...
<head>
  ...
  <title>Exam Booking || Information Management System</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/system/admin" class="logo">
      ...
      <span class="logo-lg"><b>EX</b>AMS</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/student/enroll"><i class="fa fa-circle-o"></i> Enroll Student</a></li>
            <li><a href="/students/view"><i class="fa fa-circle-o"></i> View Students</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-sitemap"></i> <span>Manage Exam Bookings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/admin/exam-bookings/view"><i class="fa fa-circle-o"></i>View Bookings</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">Rebecca</a>.</strong> All rights
    reserved.
  </footer>
