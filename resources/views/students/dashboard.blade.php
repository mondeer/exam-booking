...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-graduation-cap"></i> <span>Manage Exam Bookings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/student/exam-booking"><i class="fa fa-circle-o"></i>Book Exam</a></li>
            <li><a href="/student/exam-bookings/view"><i class="fa fa-circle-o"></i> Check Booking Status</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="imond.co.ke">Rebecca</a>.</strong> All rights
    reserved.
  </footer>
